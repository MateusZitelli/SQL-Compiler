...
public enum Production {
    ...
    DataTypeInt(TokenType.number),
    DataTypeNumeric(TokenType.NUMERIC, TokenType.OPEN_PARENTHESIS, TokenType.number, TokenType.CLOSE_PARENTHESIS),
    ...
    WhereclausulePrimeAnd(Grammatic.Logical, Grammatic.Whereclausule),
    WhereclausulePrimeOr(Grammatic.Logical, Grammatic.Whereclausule),
    LogicalAnd(TokenType.LOGICAL),
    LogicalOr(TokenType.LOGICAL),
